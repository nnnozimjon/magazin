  ...
  if (append) {
    return (
      <button
        ...
        className={classNames(
          "flex px-[15px] items-center rounded-[6px]  justify-between outline-none h-[40px] active:scale-[0.98]",
          type === "outline"
    ...
    return (
      <button
        ...
        onClick={onClick}
        className={classNames(
          "w-full flex px-[15px] items-center rounded-[6px] gap-[20px] justify-center outline-none h-[40px] active:scale-[0.98]",
          type === "outline"
            ? "text-blue-600 border border-gray-300"
            : "bg-blue-600 text-white"
        )}
      >
        {prepend}
        <p className={classNames("font-semibold ")}>{ButtonText}</p>
      </button>
    );
  } else if (more) {
    return (
    ...
    return (
      <button
        ...
        onClick={onClick}
        className={classNames(
          "w-full outline-none flex items-center justify-between px-[5px] py-[10px] rounded-[6px] active:scale-[0.98]",
          type === "outline" ? "border border-gray-300" : "bg-blue-600"
        )}
      >
        <p
          className={classNames(
            "px-[15px] font-semibold mx-auto",
            type === "outline" ? "text-blue-600" : "text-white"
          )}
        >
          {ButtonText}
